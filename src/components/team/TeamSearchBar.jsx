...
const QUICK_TEAMS = [
  { name: "Los Angeles Lakers", sport: "NBA", emoji: "🏀" },
  { name: "Kansas City Chiefs", sport: "NFL", emoji: "🏈" },
  { name: "New York Yankees", sport: "MLB", emoji: "⚾" },
  { name: "Golden State Warriors", sport: "NBA", emoji: "🏀" },
  { name: "Manchester City", sport: "Soccer", emoji: "⚽" },
  { name: "Colorado Avalanche", sport: "NHL", emoji: "🏒" },
];
    ...
    <div className="space-y-5">
        ...
        <div className="relative flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Lakers, Chiefs, Yankees..."
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {QUICK_TEAMS.map((t) => (
            <button key={t.name} onClick={() => { setQuery(t.name); onSearch(t.name); }}
              disabled={isSearching}
              ...
              <span className="text-[10px] text-gray-500 font-bold">{t.sport}</span>
            </button>
          ))}
        </div>
      </div>
