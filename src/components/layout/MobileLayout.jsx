...
export default function MobileLayout({ children, currentPageName }) {
  ...
  // ── Auth: read from localStorage (Apple Sign-In stores user there) ──────────
  ...
  // ── Logout: clear everything, redirect to Splash ─────────────────────────────
  ...
  // ── Login: go to Splash ───────────────────────────────────────────────────────
  const handleLogin = () => navigate(createPageUrl("Splash"), { replace: true });
    ...
    <div className="min-h-screen relative flex flex-col">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
                    ...
                    <>
                      ...
                      {isLegacy && (
                        <motion.div
                          ...
                          style={{ background: 'linear-gradient(135deg, rgba(234,179,8,0.2), rgba(249,115,22,0.2))', boxShadow: '0 0 15px rgba(234,179,8,0.3)' }}
                      ...
                      {isVIP && (
                        <motion.div
                          ...
                          style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.2), rgba(168,85,247,0.2))', boxShadow: '0 0 15px rgba(168,85,247,0.3)' }}
                      ...
                      {isPremium && (
                        <motion.div
                          ...
                          style={{ background: 'linear-gradient(135deg, rgba(34,211,238,0.2), rgba(168,85,247,0.2))', boxShadow: '0 0 15px rgba(34,211,238,0.3)' }}
                        >
        ...
        <main
          ...
          style={{
            paddingTop: currentPageName === "Splash" || currentPageName === "Dashboard"
              ? '0'
