          ...
          <Card className="border-4 border-red-500 shadow-2xl">
            ...
            <CardContent className="p-8 space-y-6">
              ...
              <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4">
                <p className="text-center text-red-900 font-bold text-sm">
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full border-2 border-red-400 text-red-700 hover:bg-red-50 text-base py-5 font-semibold"
                >
