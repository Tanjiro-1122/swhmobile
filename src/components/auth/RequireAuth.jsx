...
export default function RequireAuth({ children, pageName = "this feature" }) {
  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      ...
      console.error('[RequireAuth] Apple Sign In error:', err);
      alert('Apple Sign In failed. Please try again.');
    } finally {
              ...
              <div className="space-y-3">
                {isIOSNative && (
                  <Button
                    ...
                    className="w-full bg-black hover:bg-gray-900 text-white text-lg py-6 font-bold shadow-lg flex items-center justify-center gap-2"
                  >
                    {appleSignInLoading ? (
