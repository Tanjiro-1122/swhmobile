        ...
        <div className="py-16 md:py-24 bg-slate-900">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <img src="https://storage.googleapis.com/imagine-sandbox-images-staging/generated/68f93544702b554e3e1f7297/b785e5050_image.png" alt="AI Dashboard" className="rounded-xl w-full" />
                    </motion.div>
                </div>
            </div>
        </div>
