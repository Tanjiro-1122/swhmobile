...
export default function AlertsContent() {
  ...
  const createAlertMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setDialogOpen(false);
      setNewAlert({ alert_type: "odds_change", match_description: "", trigger_condition: "" });
    },
  });
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="space-y-4 py-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Match or Player</label>
                <Input
              ...
              <div>
                ...
                <Textarea
                  placeholder="e.g., 'Notify when Lakers spread moves to -4.5'"
      ...
      {isLoading ? (
        ...
        <Card className="border-2 border-dashed border-gray-300">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Create alerts to get notified about odds changes and more</p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <h3 className="text-lg font-bold text-gray-900 mb-2">{alert.match_description}</h3>
                      <p className="text-gray-700 mb-4">{alert.trigger_condition}</p>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-sm text-gray-600">{alert.is_active ? 'Active' : 'Inactive'}</span>
                      </div>
                      <Button
                        variant="ghost"
                        size="icon"
