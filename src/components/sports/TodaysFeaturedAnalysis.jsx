...
import { TrendingUp, Star, Calendar, Sparkles, AlertCircle } from "lucide-react";
import { motion } from "framer-motion";
import { base44 } from "@/api/base44Client";
import { format } from "date-fns";

export default function TodaysFeaturedAnalysis({ onLookupUsed, canLookup, onLimitReached }) {
...
For each of the TOP 3 FEATURED INSIGHTS provide:
...
2. FEATURED ANALYSIS:
   - Specific insight (e.g., "Home Win -5.5", "Over 225.5 Total Points", "Both Teams Score")
...
IMPORTANT: If no games are scheduled today, provide 3 insights for the NEXT available game day and specify the date clearly.

Return exactly 3 insights with ALL fields filled, sorted by confidence (highest first).`,
      ...
      if (result && result.recommendations && result.recommendations.length > 0) {
        ...
        setError("No analysis available at this time. Please try again later.");
      }
    } catch (err) {
      ...
      <CardHeader className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-2xl font-bold">Today's Featured Analysis</CardTitle>
              <p className="text-sm text-yellow-100">AI-Powered Insights</p>
            </div>
          </div>
          {recommendations && (
            <Button
        ...
        {!recommendations && !isLoading && !error && (
          <div className="text-center py-12">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">
              Get Today's Featured Insights
            </h3>
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Click below to get AI-powered analysis for today's matches with confidence ratings and expert insights
            </p>
            <Button
              onClick={fetchRecommendations}
              size="lg"
            ...
            >
              ...
              Load Today's Featured Analysis
            </Button>
          ...
          <div className="space-y-4">
                  ...
                  <CardContent className="p-5">
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg p-4 mb-4">
                      <div className="flex items-center justify-between mb-2">
                        <div>
                          <div className="text-sm text-gray-600 mb-1">Featured Insight</div>
                      ...
                      {bet.odds && (
                        <div className="text-sm text-gray-700 mt-2">
                          <span className="font-semibold">Current Odds:</span> {bet.odds}
                        </div>
                      )}
                    </div>
            ...
            <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-xs text-amber-800">
                <strong>Important:</strong> This analysis is AI-generated based on statistical data and current information. 
