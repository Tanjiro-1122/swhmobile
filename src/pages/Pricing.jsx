...
import { Crown, Sparkles, Check, Zap, Shield, TrendingUp, Target, BarChart3, Star, Loader2, Home } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <motion.div
              ...
              transition={{ delay: 0 }}
            >
              <Card className={`border-2 ${currentPlan === 'free' ? 'border-blue-500 shadow-xl' : 'border-gray-200'} bg-white/95 backdrop-blur-sm`}>
            ...
            >
              <Card className={`border-2 ${currentPlan === 'premium_monthly' ? 'border-purple-500 shadow-2xl' : 'border-purple-200'} relative bg-white/95 backdrop-blur-sm`}>
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                  <Badge className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-2 text-sm font-bold shadow-lg">
                    MOST POPULAR
                  </Badge>
                </div>
                <CardHeader className="text-center p-8 bg-gradient-to-br from-purple-50 to-pink-50 rounded-t-lg">
            ...
            >
              <Card className={`border-2 ${currentPlan === 'vip_annual' ? 'border-yellow-500 shadow-2xl' : 'border-yellow-200'} relative bg-white/95 backdrop-blur-sm`}>
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                ...
                <CardHeader className="text-center p-8 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-t-lg">
          ...
          {/* Comparison Table */}
          <Card className="border-2 border-white/20 mb-16 bg-white/95 backdrop-blur-sm">
          ...
          {/* Disclaimer */}
          <div className="mt-12 p-6 bg-amber-50/90 backdrop-blur-sm border-2 border-amber-200 rounded-xl">
